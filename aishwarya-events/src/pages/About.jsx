...
export default function About() {
  return (
    <div className="min-h-screen" style={{ background: "#FFFDF7", fontFamily: "'Poppins', sans-serif" }}>
      <Navbar />
      ...
      <section
        ...
        style={{
          minHeight: "60vh",
          background: "linear-gradient(135deg, #4A0E06 0%, #7A2A10 40%, #C45A00 80%, #F5C100 100%)",
          paddingTop: "80px",
        }}
      >
        {/* Mandala watermark */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-10">
          <svg viewBox="0 0 500 500" className="w-[500px] h-[500px]">
            {[...Array(24)].map((_, i) => (
              <g key={i} transform={`rotate(${i * 15} 250 250)`}>
                <ellipse cx="250" cy="60" rx="10" ry="26" fill="#F5C100" />
              </g>
            ))}
            <circle cx="250" cy="250" r="130" fill="none" stroke="#F47420" strokeWidth="2" />
            <circle cx="250" cy="250" r="90" fill="none" stroke="#F5C100" strokeWidth="1.5" />
          </svg>
        </div>

        <div className="relative z-10 px-4 py-24">
          <p className="text-sm font-bold uppercase tracking-[0.3em] mb-4" style={{ color: "#F5C100" }}>
            Established 2008
          </p>
          <h1
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Text */}
          <div>
            <span className="text-xs font-bold uppercase tracking-widest" style={{ color: "#F47420" }}>Our Story</span>
            <h2
              className="text-3xl sm:text-4xl font-bold mt-3 mb-8 leading-snug"
              style={{ fontFamily: "'Playfair Display', serif", color: "#0D4A45" }}
            >
              Crafting Unforgettable Experiences
            </h2>
            <div className="space-y-5 text-base leading-relaxed" style={{ color: "#444444", lineHeight: 1.9 }}>
              <p>
          ...
          <div className="relative">
            <div className="rounded-3xl overflow-hidden shadow-2xl" style={{ border: "4px solid #F0D9C0" }}>
              ...
              <div
                ...
                style={{ background: "linear-gradient(to top, rgba(74,14,6,0.3) 0%, transparent 60%)" }}
              />
            </div>
            {/* Floating badge */}
            <div
      ...
      {/* ── 3. Core Highlight Banner ── */}
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ background: "#F0FAF9", borderTop: "1px solid #B2DFDB", borderBottom: "1px solid #B2DFDB" }}>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {WHY_CARDS.map((card) => (
            <div
              key={card.title}
              className="bg-white rounded-3xl p-8 transition-all duration-300 hover:-translate-y-2 cursor-default"
              style={{
                border: "1px solid #F0D9C0",
                boxShadow: "0 4px 20px rgba(232,35,10,0.05)",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = "0 16px 40px rgba(232,35,10,0.14)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = "0 4px 20px rgba(232,35,10,0.05)";
              }}
            >
              <div
      ...
      >
        <h2
          className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-10 leading-tight max-w-4xl mx-auto"
          style={{ fontFamily: "'Playfair Display', serif" }}
        >
